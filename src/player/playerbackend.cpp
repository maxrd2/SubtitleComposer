...
bool PlayerBackend::isInitialized() const
{
	return m_player->m_activeBackend == this;
}

bool PlayerBackend::isActiveBackend() const
{
	return m_player->m_activeBackend == this;
}
...
void PlayerBackend::setConfig( const AppConfigGroup* const config )
{
