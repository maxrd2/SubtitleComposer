...
AppConfigGroup::AppConfigGroup(const QString &name, const QMap < QString, QString > &defaults):QObject(), m_config(0), m_name(name), m_values(), m_defaultValues(defaults)
{
	loadDefaults();
}

AppConfigGroup::AppConfigGroup(const AppConfigGroup &configGroup):QObject(), m_config(0), m_name(configGroup.m_name), m_values(configGroup.m_values), m_defaultValues(configGroup.m_defaultValues)
{
}
