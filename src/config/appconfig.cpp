...
AppConfig::setGroup(AppConfigGroup *group)
{
	if(m_groups.contains(group->name())) {
		*m_groups[group->name()] = *group;
		...
		connect(group, SIGNAL(optionChanged(const QString &, const QString &, const QString &)), this, SIGNAL(optionChanged(const QString &, const QString &, const QString &)));
	}
}
...
AppConfig::removeGroup(const QString &name)
{
	if(m_groups.contains(name)) {
		...
		disconnect(group, SIGNAL(optionChanged(const QString &, const QString &, const QString &)), this, SIGNAL(optionChanged(const QString &, const QString &, const QString &)));
