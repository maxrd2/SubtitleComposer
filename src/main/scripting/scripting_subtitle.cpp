...
void Scripting::Subtitle::checkErrors(const QObject * ranges, int errorFlags, int minDuration, int maxDuration, int minDurationPerChar, int maxDurationPerChar, int maxChars, int maxLines)
{
...
void Scripting::Subtitle::recheckErrors(const QObject * ranges, int minDuration, int maxDuration, int minDurationPerChar, int maxDurationPerChar, int maxChars, int maxLines)
{
