...
Scripting::List::List(const char *contentClass, QObject * parent):QObject(parent), m_contentClass(contentClass)
{
}

Scripting::List::List(const QList < QObject * >&backend, const char *contentClass, QObject * parent):QObject(parent), m_contentClass(contentClass), m_backend(backend)
{
}
