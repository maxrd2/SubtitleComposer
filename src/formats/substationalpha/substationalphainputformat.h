...
namespace SubtitleComposer {
	...
	SubStationAlphaInputFormat():
		InputFormat("SubStation Alpha", QStringList("ssa")), m_scriptInfoRegExp("^ *\\[Script Info\\] *\n"), m_stylesRegExp(s_stylesRegExp), m_eventsRegExp("\n\\ *\\[Events\\] *\n"), m_formatRegExp(s_formatRegExp), m_dialogueRegExp(s_dialogueRegExp), m_dialogue2RegExp(s_dialogue2RegExp), m_timeRegExp("([0-9]):([0-5][0-9]):([0-5][0-9]).([0-9][0-9])") {
		}
	...
	SubStationAlphaInputFormat(const QString & name, const QStringList & extensions, const QString & stylesRegExp, const QString & formatRegExp):
		InputFormat(name, extensions), m_scriptInfoRegExp("^ *\\[Script Info\\] *\n"), m_stylesRegExp(stylesRegExp), m_eventsRegExp("\n\\ *\\[Events\\] *\n"), m_formatRegExp(formatRegExp), m_dialogueRegExp(s_dialogueRegExp), m_dialogue2RegExp(s_dialogue2RegExp), m_timeRegExp("([0-9]):([0-5][0-9]):([0-5][0-9]).([0-9][0-9])") {
		}
	...
	protected:
		...
		AdvancedSubStationAlphaInputFormat():SubStationAlphaInputFormat("Advanced SubStation Alpha", QStringList("ass"), s_stylesRegExp, s_formatRegExp) {
		} static const char *s_stylesRegExp;
		static const char *s_formatRegExp;
	};
