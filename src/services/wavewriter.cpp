...
void* WaveWriter::convertData( void* srcData, unsigned long srcDataSize, const WaveFormat& srcFormat, const WaveFormat& dstFormat, unsigned long& convertedDataSize )
{
...
void WaveWriter::convertSample( void* srcData, unsigned long srcDataOffset, const WaveFormat& srcFormat, void* dstData, unsigned long dstDataOffset, const WaveFormat& dstFormat )
{
...
void WaveWriter::writeNumber( unsigned long number, unsigned long writeSize, bool littleEndian )
{
