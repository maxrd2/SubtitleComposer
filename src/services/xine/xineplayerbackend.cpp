...
void XinePlayerBackend::finalize()
{
	return _finalize();
}

void XinePlayerBackend::_finalize()
{
	m_timesTimer.stop();
...
void XinePlayerBackend::closeFile()
{
}
